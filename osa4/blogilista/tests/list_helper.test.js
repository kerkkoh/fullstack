...
describe('total likes', () => {
  ...
  test('when list has many blog equals the likes of all', () => {
    const result = listHelper.totalLikes(blogs)
    expect(result).toBe(36)
  })
})

describe('best based on likes', () => {
  const listWithOneBlog = [
    {
      _id: '5a422aa71b54a676234d17f8',
      title: 'Go To Statement Considered Harmful',
  ...
  test('when list has only one blog equals that', () => {
    expect(listHelper.favoriteBlog(listWithOneBlog)).toEqual(listWithOneBlog.pop())
  })
  test('when list has many blog equals the best based on the likes of all', () => {
